...
if ( ! function_exists( 'foundry_setup' ) ) :
	...
	function foundry_scripts() {
		...
		//slick slider
		wp_register_style( 'foundry-slick',   get_template_directory_uri() . '/dist/slick/' . foundry_asset_path( 'slick.css' ), array(), '1.0', 'all' );
		wp_register_style( 'foundry-slick-theme',   get_template_directory_uri() . '/dist/slick/' . foundry_asset_path( 'slick-theme.css' ), array(), '1.0', 'all' );
